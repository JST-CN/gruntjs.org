...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    // Point the wiki_url to JST-CN repo
    wiki_url : 'https://github.com/JST-CN/grunt-docs.git',
  ...
  grunt.registerTask('build', ['clean', 'copy', 'jade', 'docs', 'blog', 'oldurl','plugins', 'concat']);
